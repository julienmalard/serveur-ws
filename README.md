...
<p align="center">
  <a href="https://github.com/reseau-constellation/serveur-ws/actions/workflows/tests.yml"><img src="https://github.com/reseau-constellation/serveur-ws/actions/workflows/tests.yml/badge.svg?branch=principale"></a>
...
### Erreurs
Si le serveur a des difficultés, il enverra un message d'erreur. Le champ `idRequête` est facultatif et sera présent si l'erreur provient spécifiquement d'une requête particulière.
